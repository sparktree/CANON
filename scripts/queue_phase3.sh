...
#
# Submits sapbert -> cidx -> stage1 heads -> stage2 -> stage3 -> csp -> phase4
...
# Order: sapbert, cidx, s1ner, s1norm, s1rel, s2joint, s3ft, csp, phase4
...
S1N_JID=$(submit c02114 "afterok:$CIDX_JID" stage1_ner.slurm)
CHAIN_LOG+=("s1ner    = $S1N_JID  (c02114)  [afterok:$CIDX_JID]")

S1M_JID=$(submit r00998 "afterok:$CIDX_JID" stage1_norm.slurm)
CHAIN_LOG+=("s1norm   = $S1M_JID  (r00998)  [afterok:$CIDX_JID]")

S1R_JID=$(submit r00877 "afterok:$CIDX_JID" stage1_rel.slurm)
CHAIN_LOG+=("s1rel    = $S1R_JID  (r00877)  [afterok:$CIDX_JID]")
...
CSP_JID=$(submit r00998 "afterok:$S3_JID" stage3_csp.slurm)
CHAIN_LOG+=("csp      = $CSP_JID  (r00998)  [afterok:$S3_JID]")

P4_JID=$(submit c02114 "afterok:$CSP_JID" phase4_eval.slurm)
CHAIN_LOG+=("phase4   = $P4_JID  (c02114)  [afterok:$CSP_JID]")
