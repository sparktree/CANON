...
Self-contained so ``cd scripts/legacy_sql && python load_*.py`` works. The
active CANON pipeline does NOT import this file — see ``scripts/utils.py``.
"""
...
from config import DB_CONFIG, PostgresConfig  # legacy_sql/config.py
